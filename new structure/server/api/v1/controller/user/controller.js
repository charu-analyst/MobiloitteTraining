...
export class userController {
    ...
    try {
      ...
      if (user) {
        if (user.status === "BLOCKED") {
          ...
          await updateUserById({_id:user._id},{$set:{otp: validatedBody.otp,otpExpireTime:validatedBody.otpExpireTime}})
  ...
  /**
     * @swagger
     * /api/v1/user/userEditProfile:
     *   get:
     *     tags:
     *       - USER
     *     description: userEditProfile
     *     produces:
     *       - application/json
     *     parameters:
     *       - name: authorization
